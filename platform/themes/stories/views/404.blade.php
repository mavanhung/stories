        ...
        <div class="row pt-80">
            ...
            <div class="col-lg-6 col-md-12 text-md-center text-lg-left">
                ...
                <form action="{{ route('public.search') }}" method="get" class="search-form d-lg-flex open-search mb-30">
                    ...
                    <input class="form-control" name="q" type="text" placeholder="{{ __('Enter search text') }}">
                </form>
                <p>{{ __('The link you clicked may be broken or the page may have been removed.') }}
                </p>
                <div class="form-group">
                    <button type="submit" class="button button-contactForm mt-30"><a class="text-white" href="{{ url('') }}">Về trang chủ</a></button>
                </div>
            </div>
        </div>
    </div>
