    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="sidebar-widget animated mb-30">
                    ...
                    <div class="textwidget">
                        ...
                        @if (theme_option('social_1_url'))
                            <p><strong class="color-black">{{ __('Follow me') }}</strong><br></p>
                        @endif
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                @if (theme_option('social_' . $i . '_url') && theme_option('social_' . $i . '_name'))
                                    <li class="list-inline-item"><a
                                            ...
                                            href="{{ theme_option('social_' . $i . '_url') }}" target="_blank"
                                            title="{{ theme_option('social_' . $i . '_name') }}"><i
                                                class="elegant-icon {{ theme_option('social_' . $i . '_icon') }}"></i></a>
                                    </li>
                                @endif
                            @endfor
                        </ul>
...
@if (theme_option('facebook_comment_enabled_in_post', 'yes') == 'yes' ||
    (theme_option('facebook_chat_enabled', 'yes') == 'yes' && theme_option('facebook_page_id')))
    <div id="fb-root"></div>
    <script>
    ...
    @endif
@endif
<div id="scrollTop"><i class="elegant-icon arrow_up"></i></div>
{!! Theme::footer() !!}
</body>
