                        ...
                        <div class="carausel-post-1 hover-up border-radius-10 overflow-hidden transition-normal position-relative">
                            ...
                            <div class="slide-fade">
                                ...
                                <div class="position-relative post-thumb">
                                    ...
                                    <div class="thumb-overlay img-hover-slide position-relative lazy-background" data-bg_url="{{ RvMedia::getImageUrl($post->image, null, false, RvMedia::getDefaultImage()) }}">
