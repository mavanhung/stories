<ul class="social-share">
    ...
    {{-- facebook --}}
    <li>
        <a class="fb-share-button fb" title="Share Facebook"
    ...
    {{-- messenger --}}
    <li>
        <a class="fb-mess-share-button mess" title="Share Messenger" target="_blank"
            rel="nofollow"
            data-href="{{ $post->url }}"
            data-title="{{ $post->description }}">
    ...
    {{-- twitter --}}
    <li>
        <a class="twitter-share-button tw" title="Share Twitter" target="_blank"
            rel="nofollow"
            data-href="{{ $post->url }}"
            data-title="{{ $post->description }}">
