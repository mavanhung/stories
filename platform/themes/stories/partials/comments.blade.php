        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <div class="form-group fl_icon">
                    ...
                    <input name="name" class="form-input" type="text" placeholder="Họ và tên" required>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <div class="form-group fl_icon">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group fl_icon">
                    ...
                    <input name="phone" class="form-input" type="text" placeholder="Số điện thoại" required>
                </div>
            </div>
                            ...
                            <div class="emoji">
                                ...
                                <svg class="rating-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <ellipse cx="356.4" cy="205.3" rx="44.2" ry="44.2"
                                        fill="#3e4347" />
                                    <g fill="#fff">
                                        <ellipse transform="scale(-1) rotate(45 454 -906)" cx="375.3"
